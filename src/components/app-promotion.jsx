...
const AppPromotion = () => {
  ...
  return (
    <div className="md:px-8 md:py-16 px-5 py-12">
      <div className="relative bg-gradient-to-br from-gray-50 to-white py-20 px-4 sm:px-6 lg:px-16 overflow-hidden section">
        {/* Decorative Elements */}
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="w-full md:w-1/2 order-2 md:order-1">
              ...
              <p className="text-gray-600 leading-relaxed mb-8">
                The Captain Taxis is your go-to transportation service offering
                a range of specialized services tailored to meet your diverse
                needs. We know how hectic it can be when you're in a hurry to
                reach your destination. That's why we've chosen skilled drivers
                who appreciate the importance of being punctual, providing a
