...
const onChangetime = (time, timeString) => {
    ...
    <>
      ...
      <div className="flex  gap-[20px] max-h-screen  mt-[150px] px-6 ">
        ...
        <div className="w-[800px]  p-6 flex flex-col testomonial-shadow rounded-2xl">
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <Input value="9 Waterloo Rd, Macquarie Park NSW 2113, Australia" className="pr-10  !text-[18px]  !text-gray-600" variant="underlined" placeholder="Underlined" />
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              <Input value="117 Ryedale Rd, West Ryde NSW 2114, Australia" variant="underlined" className="pr-10  !text-[18px]  !text-gray-600" readOnly />
        ...
        <div className="relative">
          ...
          {/* When to Travel */}
       <div className="mb-6">
      <label className="text-[18px] font-semibold text-black mb-3 block">
        When to Travel?
      </label>
      <div className="flex gap-3 items-center">
        <TimePicker className="w-full h-[40px]"
          value={time}
  ...
  <TextArea
      ...
      />
          ...
          {/* Confirm Button */}
          <Button className="w-full !bg-[#4d2d7c] !py-[25px] !text-[20px] !hover:bg-white !text-white !rounded-lg !font-medium">
            Confirm & Continue
          </Button>
        </div>
      </div>
